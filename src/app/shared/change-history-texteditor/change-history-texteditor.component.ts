import {ChangeDetectorRef, Component, forwardRef, Input, NgZone, OnInit, ViewChild, HostBinding} from '@angular/core';
...
import {CitationBlot} from '../text-editor/citation-blot';
...
@Component({
  selector: 'app-change-history-texteditor',
  templateUrl: './change-history-texteditor.component.html',
  styleUrls: ['./change-history-texteditor.component.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => ChangeHistoryTexteditorComponent),
            multi: true
        }
    ]
})
export class ChangeHistoryTexteditorComponent extends CustomAccessorHandlerDirective<string | number | null> implements OnInit {
